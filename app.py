...
@token_required
@role_required(1, 2)  # Super Admin, Admin
def get_all_users():
    """Get all users - SuperAdmin sees all, Admin sees all except SuperAdmins. Supports filtering by role."""
    try:
...
def delete_user(user_id):
    ...
    try:
        ...
        # Check if user is a SuperAdmin (prevent deleting other SuperAdmins)
...
@token_required
@role_required(1, 2, 3)  # Super Admin, Admin, Counsellor
...
@token_required
@role_required(1, 2)  # Super Admin, Admin only
def get_audit_logs():
